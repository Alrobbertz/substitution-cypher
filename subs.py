...
englishLetterFreq.sort(key=lambda x: x[1], reverse=True)

# Create a Hash to store letter frequencies
alphabet=string.ascii_uppercase
frequencies = {letter: 0.00 for letter in alphabet}
...
temp = [(l, f/len(cypher_text)) for l, f in frequencies.iteritems()]
temp.sort(key=lambda x: x[1], reverse=True)


print(temp, englishLetterFreq)